...
mkdir -p $pwd/task/dir1 $pwd/task/dir2 $pwd/task/dir3/dir4

# изменяем текущую директорию на task
cd $pwd/task

# создаём пустой файл task/dir2/empty
touch $pwd/task/dir2/empty
...
echo "/task/dir2/list.txt" >> /task/dir1/summary.txt
...
#к сожалению не могу проверить вывод, выдает ошибку /bin/sh: 2: ./task.sh: not found. 
#Задал вопрос в пачку

cat /task/dir2/hello.sh echo $NAME >> /task/dir1/summary.txt
